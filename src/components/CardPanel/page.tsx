			...
			>
				<Card
					...
					onChangeRating={(title: string, rating: number) => {
						dispatchRatingList({ type: "update", payload: { title, rating } });
					}}
					rating={ratingList.get("โรงพยาบาลจุฬาลงกรณ์ สภากาชาดไทย")}
				...
				<Card
					...
					rating={ratingList.get("โรงพยาบาลราชวิถี")}
					deleteRatingList={removeRating}
				/>
				<Card
					...
					rating={ratingList.get("โรงพยาบาลธรรมศาสตร์")}
					deleteRatingList={removeRating}
				/>
			</div>
